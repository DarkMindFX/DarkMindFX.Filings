...
namespace DMFX.Test.SECParsers
{
    ...
    public class TestAAPL
    {
        ...
        public void Parse_10Q_Success_20170701()
        {
            ...
            Assert.GreaterOrEqual(result.Statements[1].Records.Count, 40, string.Format("APPL 10Q: Invalid number of records in statement '{0}' returned, Expected - greater 40, Actual - {1}", result.Statements[1].Title, result.Statements[1].Records.Count));
