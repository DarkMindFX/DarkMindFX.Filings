...
namespace DMFX.Test.SECParsers
{
    ...
    public class TestBAC
    {
        ...
        public void BAC_10Q_Success_2017Q2()
        {
            ...
            // parameters
            secParams.FileContent = new FileStream(Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "..", "..", "..", "Sample Reportings", ConfigurationManager.AppSettings["File_SEC_BAC_10-Q_2017Q2"]), FileMode.Open);
