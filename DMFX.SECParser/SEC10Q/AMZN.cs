...
namespace DMFX.SECParser.SEC10Q
{
    ...
    public class AMZN : SECParserBase
    {
        ...
        string[][] statOfOpsTags = {
                new string[] { "us-gaap:SalesRevenueGoodsNet", "SalesRevenueGoodsNet" },
                new string[] { "us-gaap:SalesRevenueServicesNet", "SalesRevenueServicesNet" },
                ...
                new string[] { "us-gaap:FulfillmentExpense", "FulfillmentExpense" },
                new string[] { "us-gaap:MarketingExpense", "MarketingExpense" },
                new string[] { "us-gaap:TechnologyAndContentExpense", "TechnologyAndContentExpense" },
                new string[] { "us-gaap:GeneralAndAdministrativeExpense", "GeneralAndAdministrativeExpense" },
                new string[] { "us-gaap:OtherCostAndExpenseOperating", "OtherCostAndExpenseOperating" },
                new string[] { "us-gaap:CostsAndExpenses", "CostsAndExpenses" },
                new string[] { "us-gaap:OperatingIncomeLoss", "OperatingIncomeLoss" },
                new string[] { "us-gaap:InvestmentIncomeInterest", "InvestmentIncomeInterest" },
                new string[] { "us-gaap:InterestExpense", "InterestExpense" },
                new string[] { "us-gaap:OtherNonoperatingIncomeExpense", "OtherNonoperatingIncomeExpense" },
                new string[] { "us-gaap:NonoperatingIncomeExpense", "NonoperatingIncomeExpense" },
                new string[] { "us-gaap:IncomeLossFromContinuingOperationsBeforeIncomeTaxesMinorityInterestAndIncomeLossFromEquityMethodInvestments", "IncomeLossFromContinuingOperationsBeforeIncomeTaxesMinorityInterestAndIncomeLossFromEquityMethodInvestments" },
                new string[] { "us-gaap:IncomeTaxExpenseBenefit", "IncomeTaxExpenseBenefit" },
                new string[] { "us-gaap:IncomeLossFromEquityMethodInvestments", "IncomeLossFromEquityMethodInvestments" },
        ...
        string[][] statOfCompIncomeTags = {
                ...
                new string[] { "us-gaap:OtherComprehensiveIncomeLossNetOfTax", "OtherComprehensiveIncomeLossNetOfTax" },
        ...
        protected override XmlNamespaceManager PrepareNamespaceMngr(XmlDocument doc)
        {
            ...
            nsmgr.AddNamespace("amzn", "http://www.amazon.com/20170630");
